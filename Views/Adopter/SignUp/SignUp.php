                    ...
                    <div class="container" style="margin-top: 12%;">
                        ...
                        <div class="row d-flex justify-content-center"
                            ...
                            <div class="col" style="color: white;">
                                <h1>Sign Up as an Adopter Today!</h1>
                                <p class="fs-5">Grow your family with us <br>
                                    ...
                                    <div class="card-body d-flex flex-column align-items-center"
                                        ...
                                        <form action="../../../Controller/Adopter/Signup_Handler.php"
                                            ...
                                            <div class="mb-3" style="color: white;">
                                                ...
                                                <p style="color: red;"><?php if ($genderError != "") {echo $genderError;} else {echo "";} ?></p>
                                            ...
                                            <!-- Address -->
                                            <div class="mb-3">
                                                <textarea onblur="validateInput(this)" class="form-control" placeholder="Enter your text here..."
                                                    name="address" id="address" rows="2" cols="20">

                                            </textarea>
                                                <p id="addressError" style="color: red;"><?php if ($addressError != "") {echo $addressError; } else {echo "";} ?></p>
                                            </div>

                                            <!-- Profession -->
                                            <div class="mb-3"><input onblur="validateInput(this)" class="form-control" type="text" name="profession"
                                                    id="profession" placeholder="Profession">
                                                <p id="professionError" style="color: red;"><?php if ($professionError != "") {echo $professionError;} else {echo "";} ?></p>
                                            </div>
